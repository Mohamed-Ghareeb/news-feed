        ...
        <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($all_trashed as $index=>$admin)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('dashboard.admins.restore', $admin->id) }}" class="btn btn-success btn-sm"><i class="fa fa-reply"></i> @lang('site.restore')</a>
                                            {{-- <a href="{{ route('dashboard.admins.delete', $admin->id) }}" class="btn btn-danger delete btn-sm"><i class="fa fa-reply"></i> @lang('site.delete')</a> --}}
                                            <form action="{{ route('dashboard.admins.delete', $admin->id) }}" method="post" style="display: inline-block">
