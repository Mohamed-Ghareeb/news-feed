        ...
        <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($all_trashed as $index=>$country)
                                    <tr>

                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $country->name }}</td>
                                        <td>
                                            <a href="{{ route('dashboard.countries.restore', $country->id) }}" class="btn btn-success btn-sm"><i class="fa fa-reply"></i> @lang('site.restore')</a>
                                            {{-- <a href="{{ route('dashboard.countries.delete', $country->id) }}" class="btn btn-danger delete btn-sm"><i class="fa fa-reply"></i> @lang('site.delete')</a> --}}
                                            <form action="{{ route('dashboard.countries.delete', $country->id) }}" method="post" style="display: inline-block">
