    ...
    <section class="content">
        ...
        <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title" style="margin-bottom: 15px">@lang('site.tags')</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @if (count($all_trashed) > 0)
                                            <a href="{{ route('dashboard.tags.all_trashed') }}" class="btn btn-danger"><i class="fa fa-trash"></i> @lang('site.all_trashed')</a>
                                        @endif
                                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $tag->name }}</td>
                                        <td>
                                            <a href="{{ route('dashboard.tags.edit', $tag->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
