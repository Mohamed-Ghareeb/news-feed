...
Route::prefix('dashboard')->name('dashboard.')->group(function () {
    ...
    Route::middleware(['admin:admin'])->group(function () {
        ...
        Route::get('/tags/all_trashed', 'TagsController@all_trashed')->name('tags.all_trashed');
        Route::get('/tags/restore/{id}', 'TagsController@restore')->name('tags.restore');
        Route::delete('/tags/delete/{id}', 'TagsController@delete')->name('tags.delete');
        // Posts Routes    
        Route::resource('posts', 'PostsController')->except(['show']);
        Route::get('/posts/single-post/{post}', 'PostsController@single')->name('posts.single');
        // Plans Routes    
